...
def upgrade() -> None:
    ...
    op.add_column(
        "factions_descriptions", sa.Column("faction_id", sa.Integer(), nullable=False)
    )
    op.add_column(
        "factions_descriptions", sa.Column("media_id", sa.Integer(), nullable=False)
    )
    op.create_foreign_key(
        None, "factions_descriptions", "factions", ["faction_id"], ["id"]
    )
