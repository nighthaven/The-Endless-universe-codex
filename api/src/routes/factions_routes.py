...
from src.schemas.base.faction_base import MediaResponse, FactionResponse
...
def get_all_factions(faction_repository: Annotated[Any, Depends(FactionDescriptionRepository)]):
    list_factions = faction_repository.find_by()
    return [FactionDescriptionResponse(
