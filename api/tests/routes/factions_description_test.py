...
class TestGetFactionsDescriptions:
    def test_get_faction_description(self, client):
        ...
        assert first_element_response_json["faction"] == {'name': faction_description.faction.name}
        assert first_element_response_json["description"] == faction_description.description
        assert first_element_response_json["media"] == {"name": faction_description.media.name.value}
        ...
        assert first_element_response_json["government"] == faction_description.government
        assert first_element_response_json["ideology"] == faction_description.ideology
        assert first_element_response_json["home_planet"] == faction_description.home_planet
        assert first_element_response_json["populations"] == faction_description.populations
        assert first_element_response_json["traits"] == faction_description.traits
        assert first_element_response_json["starting_technology"] == faction_description.starting_technology
