      ...
      <ItemLayoutComponent className="about-text">
        <div className="about-component-window">
          <div className="about-component-window-header">
            ...
            <p className="about-component-p">
              {' '}
              My name is Boris, I am a developer, this is one of my multiple
              projects.
            </p>
            <br />
            <p className="about-component-p">
              This website is a fanbase of the universe of amplitude, made with
              FastAPI and React. The goal is, when finish, to have like an API
              where any user should be able to search for lore information about
              the endless universe.
            </p>
            <br />
            <p className="about-component-p">
              Thanks a lot to all the staff of Amplitude Studio who answer me
              about these information, this website has been made with their
              agreement.
            </p>
          </div>
